...
The Semantic Web movement has long recommended an approach of embedding
RDF data models within web pages and documents using RDFa\cite{adida2012rdfa}
and RDFa Lite\cite{lite2004rdfa}.
